...
const displayTitle = computed(() => {
    return props.pageTitle || siteConfig.profile.name;
});
                    ...
                    <section class="left-panel">
                        <header class="hero">
                            ...
                            <h1 class="name" :style="{ opacity: heroAvatarNameOpacity }">
                                <template v-for="part in splitLatinText(displayTitle)" :key="part.text">
                            ...
                            <div v-if="showSlogan" id="bioContainer" class="bio-container">
                                <TypewriterSlogan
                            ...
                            <SocialLinks v-if="showSocialLinks" :config="siteConfig.socialLinks" />
                        </header>
